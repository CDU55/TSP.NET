...
namespace PostCommentService
{
    ...
    public partial class PostDTO : object
    {
        ...
        private System.Collections.Generic.List<PostCommentService.CommentDTO> CommentsField;
        ...
        public System.Collections.Generic.List<PostCommentService.CommentDTO> Comments
        {
            get
            {
    ...
    public partial class CommentDTO : object
    {
        ...
        private PostCommentService.PostDTO PostField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public PostCommentService.PostDTO Post
        {
            get
            {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="PostCommentService.IPostComment")]
    public interface IPostComment
    {
        ...
        System.Threading.Tasks.Task<PostCommentService.PostDTO> GetPostByIdAsync(int id);
        ...
        System.Threading.Tasks.Task<PostCommentService.PostDTO> GetPostByTitleAsync(string title);
        ...
        System.Threading.Tasks.Task<PostCommentService.PostDTO> SubmitPostAsync(PostCommentService.PostDTO post);
        ...
        System.Threading.Tasks.Task<PostCommentService.PostDTO> UpdatePostAsync(PostCommentService.PostDTO newPost);
        ...
        System.Threading.Tasks.Task<bool> DeletePostAsync(int postId);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<PostCommentService.PostDTO>> GetAllPostsAsync();
        ...
        System.Threading.Tasks.Task<PostCommentService.CommentDTO> GetCommentByIdAsync(int id);
        ...
        System.Threading.Tasks.Task<PostCommentService.CommentDTO> SubmitCommentAsync(PostCommentService.CommentDTO comment);
        ...
        System.Threading.Tasks.Task<PostCommentService.CommentDTO> AddCommmentAsync(int postId, PostCommentService.CommentDTO comment);
        ...
        System.Threading.Tasks.Task<PostCommentService.CommentDTO> UpdateCommentAsync(PostCommentService.CommentDTO oldComment, PostCommentService.CommentDTO newComment);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<PostCommentService.PostDTO>> GetAllPostsAndRelatedCommentsAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface IPostCommentChannel : PostCommentService.IPostComment, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class PostCommentClient : System.ServiceModel.ClientBase<PostCommentService.IPostComment>, PostCommentService.IPostComment
    {
        ...
        public System.Threading.Tasks.Task<PostCommentService.PostDTO> GetPostByIdAsync(int id)
        {
            return base.Channel.GetPostByIdAsync(id);
        }
        
        public System.Threading.Tasks.Task<PostCommentService.PostDTO> GetPostByTitleAsync(string title)
        {
            return base.Channel.GetPostByTitleAsync(title);
        }
        
        public System.Threading.Tasks.Task<PostCommentService.PostDTO> SubmitPostAsync(PostCommentService.PostDTO post)
        {
            return base.Channel.SubmitPostAsync(post);
        }
        
        public System.Threading.Tasks.Task<PostCommentService.PostDTO> UpdatePostAsync(PostCommentService.PostDTO newPost)
        {
            return base.Channel.UpdatePostAsync(newPost);
        }
        
        public System.Threading.Tasks.Task<bool> DeletePostAsync(int postId)
        {
            return base.Channel.DeletePostAsync(postId);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<PostCommentService.PostDTO>> GetAllPostsAsync()
        {
            return base.Channel.GetAllPostsAsync();
        }
        
        public System.Threading.Tasks.Task<PostCommentService.CommentDTO> GetCommentByIdAsync(int id)
        {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<PostCommentService.PostDTO>> GetAllPostsAndRelatedCommentsAsync()
        {
